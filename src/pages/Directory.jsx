import { Container, Row, Col, Table, Tabs, Tab, Card, Badge, Accordion } from 'react-bootstrap'
...
const Directory = () => {
  ...
  const nationalAgencies = [
    ...
    { no: 3, name: 'Elsie C. Sibal', position: 'Election Office IV', department: 'Commission on Election', deptEmail: [], contact: ['045 491 8358'], personalEmail: [] },
  ...
  const schoolsData = {
    west: [
      ...
      { no: 17, name: "Sta. Lucia National High School", location: "Barangay Sta. Lucia", head: "Ruperto G. Patangui Jr.", head: "Ruperto G. Patangui Jr.", email: "rupertojr.patangui@deped.gov.ph", contact: "09388000378" },
    ],
    east: [
  ...
  return (
    <div className="directory-page bg-light min-vh-100">
                      ...
                      <Accordion.Item eventKey={idx.toString()} key={idx} className="border-bottom py-2">
                        ...
                        <Accordion.Body>
                          <Table responsive hover size="sm" className="mt-2">
                            ...
                            <tbody>
                              {barangayOfficials.filter(off => off.department === brgy).map((off, i) => (
                                <tr key={i}>
                                  <td className="small fw-bold">{off.name}</td>
      ...
      <style>{`
        ...
        .custom-school-accordion .accordion-button {
          background-color: transparent;
          color: #333;
          padding: 1.25rem 0;
          box-shadow: none;
        }
        .custom-school-accordion .accordion-button:not(.collapsed) {
          color: var(--primary);
          background-color: transparent;
        }
        .custom-school-accordion .accordion-item {
          background-color: transparent;
          border-left: none;
          border-right: none;
          border-top: none;
